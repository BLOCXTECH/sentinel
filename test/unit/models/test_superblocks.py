    ...
    items = [
        {
            ...
            "DataString": '[["proposal", {"end_epoch": 2122520400, "name": "dean-miller-5493", "payment_address": "yYe8KwyaUu5YswSYmB3q3ryx8XTUu9y7Ui", "payment_amount": 25.75, "start_epoch": 1474261086, "type": 1, "url": "http://blocxcentral.org/dean-miller-5493"}]]',
        ...
        },
        {
            ...
            "DataString": '[["proposal", {"end_epoch": 2122520400, "name": "fernandez-7625", "payment_address": "yTC62huR4YQEPn9AJHjnQxxreHSbgAoatV", "payment_amount": 32.01, "start_epoch": 1474261086, "type": 1, "url": "http://blocxcentral.org/fernandez-7625"}]]',
...
def test_deterministic_superblock_creation(go_list_proposals):
    ...
    for item in go_list_proposals:
        (go, subobj) = GovernanceObject.import_gobject_from_blocxd(blocxd, item)
    ...
    sb = blocxlib.create_superblock(prop_list, 72000, max_budget, misc.now())

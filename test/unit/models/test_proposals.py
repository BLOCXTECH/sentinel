...
def go_list_proposals():
    items = [
        ...
        },
        {
            ...
            "DataString": '[["proposal", {"end_epoch": 2122520400, "name": "fernandez-7625", "payment_address": "yYe8KwyaUu5YswSYmB3q3ryx8XTUu9y7Ui", "payment_amount": 25.75, "start_epoch": 1474261086, "type": 1, "url": "http://blocxcentral.org/fernandez-7625"}]]',
...
def proposal():
    ...
    pobj = Proposal(
        ...
        url="https://blocxcentral.com/wine-n-cheeze-party",
...
def test_approved_and_ranked(go_list_proposals):
    from blocxd import BlocXDaemon

    blocxd = BlocXDaemon.initialize(None)

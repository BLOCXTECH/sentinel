...
blocxd = BlocXDaemon.from_blocx_conf(config.blocx_conf)
import misc
...
pr = Proposal(
    name="proposal7",
    url="https://blocxcentral.com/proposal7",
